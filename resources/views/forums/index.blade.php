        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                @forelse ($categories as $category)
                    <a href="{{ route('forums.category', $category->slug) }}" class="block bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                        <div class="flex items-start justify-between">
                            ...
                            <div class="text-right ml-6 shrink-0">
                                <div class="text-sm text-gray-500">
                                    <span class="font-semibold text-gray-700">{{ $category->threads_count }}</span> {{ Str::plural('thread', $category->threads_count) }}
                                </div>
                            </div>
                        </div>
                    </a>
