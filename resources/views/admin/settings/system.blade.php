<x-layouts.admin>
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500 mt-1">Configure your TruckNav application.</p>
    </div>
        ...
        <form method="POST" action="{{ route('admin.settings.system.update') }}">
            ...
            <div class="mb-4">
                ...
                <input id="app_url" type="url" name="app_url" value="{{ old('app_url', $settings['app_url']) }}"
                    class="w-full border-gray-300 rounded-lg shadow-sm focus:border-maroon-500 focus:ring-maroon-500 text-sm" required>
                <p class="mt-1 text-xs text-gray-400">Full URL including protocol (e.g. https://trucknav.com.au)</p>
            </div>
            ...
            <div class="mb-6">
                ...
                <p class="mt-1 text-xs text-gray-400">When enabled, only admins can access the site.</p>
            </div>
